    ...
    stages {
        ...
        stage ('Use Ansible to provision Docker and folders') {
            ...
            echo 'Dynamically provisioning Docker into AWS Machines'
                ...
                ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook --inventory=~/hrapp/ansible_hosts --key-file ${SSH_KEY} playbooks/02-docker.yml -u ec2-user
